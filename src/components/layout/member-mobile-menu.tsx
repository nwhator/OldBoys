        ...
        <>
          ...
          >
            ...
            <nav className="mt-4 grid grid-cols-1 gap-2 text-sm font-semibold text-slate-800 sm:grid-cols-2">
              <Link href="/dashboard" aria-current={isActivePath("/dashboard") ? "page" : undefined} onClick={closeMenu} className={`rounded-md border px-3 py-2 text-center transition-colors ${isActivePath("/dashboard") ? "border-(--primary) bg-(--primary) text-white" : "border-slate-200 hover:border-(--primary) hover:bg-(--primary) hover:text-white"}`}>Dashboard</Link>
              <Link href="/profile" aria-current={isActivePath("/profile") ? "page" : undefined} onClick={closeMenu} className={`rounded-md border px-3 py-2 text-center transition-colors ${isActivePath("/profile") ? "border-(--primary) bg-(--primary) text-white" : "border-slate-200 hover:border-(--primary) hover:bg-(--primary) hover:text-white"}`}>Profile</Link>
              <Link href="/voting" aria-current={isActivePath("/voting") ? "page" : undefined} onClick={closeMenu} className={`rounded-md border px-3 py-2 text-center transition-colors ${isActivePath("/voting") ? "border-(--primary) bg-(--primary) text-white" : "border-slate-200 hover:border-(--primary) hover:bg-(--primary) hover:text-white"}`}>Voting</Link>
              <Link href="/payments" aria-current={isActivePath("/payments") ? "page" : undefined} onClick={closeMenu} className={`rounded-md border px-3 py-2 text-center transition-colors ${isActivePath("/payments") ? "border-(--primary) bg-(--primary) text-white" : "border-slate-200 hover:border-(--primary) hover:bg-(--primary) hover:text-white"}`}>Payments</Link>
            </nav>
