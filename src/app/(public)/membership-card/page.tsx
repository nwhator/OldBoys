...
export const metadata: Metadata = {
  ...
  description: "Preview of member digital identity card experience."
};

export default function MembershipCardPage() {
  return (
    <main className="mx-auto max-w-6xl px-4 py-14 md:px-8">
      <h1 className="text-4xl font-black text-(--primary)">Digital Membership Card</h1>
      <p className="mt-3 text-slate-700">Approved members receive verified identity access in the member portal.</p>
      ...
      <section className="mt-8 grid gap-8 lg:grid-cols-2">
        ...
        <article className="editorial-card rounded-xl p-6">
          ...
          <p className="mt-3 text-sm text-slate-700">
            After admin approval, your member profile serves as your digital card and proof of association access.
          </p>
